const BASE='https://services8.arcgis.com/GyR85gR88mMqIY4t/ArcGIS/rest/services/HydroLAKES_v10/FeatureServer/query';
...
export default async function handler(req,res){
  ...
  try{
    ...
    if(!features.length){const dx=.02,dy=.02;d=await query({geometry:`${lng-dx},${lat-dy},${lng+dx},${lat+dy}`,geometryType:'esriGeometryEnvelope',inSR:'4326',spatialRel:'esriSpatialRelIntersects'});features=d?.features||[]}
